...
map.df<-sapply(trainSplit[,-333], as.numeric)
...
train.map.df<-sapply(train.set[,-333], as.numeric)
df.map<-umap(train.map.df[,-c(333)])
...
test.map.df<-sapply(test.set, as.numeric)
