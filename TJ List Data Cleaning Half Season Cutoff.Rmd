...
mlb_only_tj_list$Year_for_stats<-ifelse(mlb_only_tj_list$Mon >= 7, mlb_only_tj_list$Year,mlb_only_tj_list$Year - 1) 
...
#write.csv(df.total, "/Users/timmorales/Desktop/STAT 6341/Tommy John Project/Data/Fully Joined Df test.csv")
```
